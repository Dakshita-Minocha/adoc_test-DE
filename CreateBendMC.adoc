...
=== Back-gauge carriers
It is possible to model the back-gauge _carriers_  that support and move the gauges. This is not found for most of the MetaCAM bend machines, but we have this for all the Trumpf machines. Different gauging systems will require slightly different approaches here. 
